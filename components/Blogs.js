...
const Blogs = () => {
  return (
    <div>
      <div className="pl-10 text-3xl">Blogs</div>

      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <p className="text-gray-500 mt-4 max-w-2xl py-6 text-xl lg:mx-auto lg:text-center">
        ...
        <div className="my-10 ">
          <dl className="space-y-10 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10 md:space-y-0 ">
            {features.map((feature) => (
              <div
                key={feature.name}
                className="border-black relative rounded-lg border-2 "
              >
                <dt>
                  <h3 className=" text-gray-900 ml-4 text-lg font-extrabold leading-6">
                    {feature.name}
                  </h3>
                </dt>
                <dd className="text-gray-500 mt-2 ml-8 text-base">
                  {feature.description}
                </dd>
                <dd className="ml-8 font-bold underline">
